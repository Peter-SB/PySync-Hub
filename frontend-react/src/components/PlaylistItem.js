...
function PlaylistItem({ playlist, refreshPlaylists, isSelected, onSelectChange }) {
  ...
  return (
    <div className="flex flex-row items-center">
      <div
        className={`flex items-center p-2 rounded shadow-sm transition-shadow my-2 mx-1 flex-1 ${isDisabled ? 'bg-gray-200 hover:shadow-none' : 'bg-white hover:shadow-md'
          }`}
      >
        <input
          type="checkbox"
