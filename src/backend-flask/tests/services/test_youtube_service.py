...
class TestYouTubePlaylistImport:
    """
    Comprehensive tests for YouTube playlist import functionality.
    ...
    def test_add_valid_youtube_playlist(self, client):
        ...
        response = client.post('/api/playlists', 
                              json={"url_or_id": "https://www.youtube.com/playlist?list=PLrAXtmErZgOeiKm4sgNOknGvNjby9efdf"})
        
        assert response.status_code == 201
        playlists = response.get_json()
        
        # Verify playlist was added
        assert any(p["external_id"] == "PLrAXtmErZgOeiKm4sgNOknGvNjby9efdf" for p in playlists)
        
        # Verify playlist details in database
        added_playlist = Playlist.query.filter_by(external_id="PLrAXtmErZgOeiKm4sgNOknGvNjby9efdf").first()
    ...
    def test_add_youtube_playlist_with_unavailable_videos(self, client):
        ...
        response = client.post('/api/playlists',
                              json={"url_or_id": "https://www.youtube.com/playlist?list=PLrAXtmErZgOeiKm4sgNOknGvNjby9efdf&unavailable=true"})
    ...
    def test_sync_youtube_playlist(self, app):
        ...
        with app.app_context():
            ...
            updated_playlist = Playlist.query.filter_by(external_id="PLrAXtmErZgOeiKm4sgNOknGvNjby9efdf").first()
